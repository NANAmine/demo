      ...
      <div class="am-u-sm-12">
      	...
      	<input type="hidden" name="id" id="id" value="${content.id}">
		    ...
		    <div class="am-margin am-text-right">
		        <button type="button" id="add_button" class="am-btn am-btn-primary am-btn-xs">添加爬虫数据</button>
		    ...
		    <a href="show_video.do?content_id=${content.id}">视频上传详细页面</a>
...
$(function(){ 
  ...
  //爬虫数据添加按钮点击事件
	$("#add_button").click(function() {
		var saveData={"id":$("#id").val()};
		var description=$("#description").val()
		$.ajax({
			contentType:"application/x-www-form-urlencoded",
		    type : "POST",
		    url : "<%=request.getContextPath()%>/get_news.do",
		    data : saveData,
		    dataType: "json",
		    success : function(data) {
		    	var news=description+data.news.content;
		        if(data.flag=="1"){
		        	$("#description").val(news);
		            alert("爬虫数据查询成功！");
